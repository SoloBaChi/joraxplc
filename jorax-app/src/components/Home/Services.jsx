    ...
    <section className="services-section" id={"services"}>
      ...
      <div className="flex-container-2">
        ...
        <div className="flex-item">
          <h3>jorax foods</h3>
          <p>
            We offer quality, natural, and low cholesterol Palm Oil that makes
      ...
      <div className="flex-container-2">
        <div className="flex-item">
          ...
          <p>
            We specialize in the distribution and marketing of Pharmaceuticals
      ...
      <div className="flex-container-2">
        <div className="flex-item">
          <div className="img-container">
            <img
              src={`/assets/images/consultancy-photo.svg`}
              alt="consultancy"
            />
          </div>
        </div>
        <div className="flex-item">
          ...
          <p>
            We provide drug information for medical practitioners, individuals,
