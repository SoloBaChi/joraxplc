...
const LaunchCountDown = () => {
  ...
  useEffect(() => {
    let countDownDate = new Date("apr 10, 2024 00:00:00").getTime();
...
<img src={`/jorax-logo.jpg`} className="logo" alt="jorax logo"/>
{/* <h1 className="company-name">Jorax Healthcare</h1> */}
